...
sampleset_QA = samplerQA.sample(bqm_diffusion, num_reads=3500, label='QFI - Channel')
print(sampleset_QA.first)
print(len(sampleset_QA.lowest())/len(sampleset_QA))
np.save('QA_samples_0713_00_3500', sampleset_QA.record)
np.save('QA_samples_0713_00_3500_lowest', sampleset_QA.lowest().record)
