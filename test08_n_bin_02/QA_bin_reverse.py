...
QA_F_path = './'
QA_samples = np.load(QA_F_path + 'QA_samples_12_02_02000_0500_0020.npy')
...
reverse_schedule = make_reverse_anneal_schedule(s_target=0.3, hold_time=100, ramp_up_slope=max_slope)
reinit_flag = False
